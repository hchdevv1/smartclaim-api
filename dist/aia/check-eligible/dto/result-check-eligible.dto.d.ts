...
export declare class ResultCheckEligibleDto {
...
export declare class PolicyNumberListDto {
    HTTPStatus: HttpMessageDto;
    Result?: ResultPolicyNumberInfo;
}
declare class ResultPolicyNumberInfo {
    PolicyNumberInfo?: FindPolicyNumberInfo[];
}
export declare class FindPolicyNumberInfo {
    RefId?: string;
    HN?: string;
    VN?: string;
    PolicyNo?: string;
